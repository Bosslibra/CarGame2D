...
//errors
#define ERROR_EMPTY_CANVAS 11
#define ERROR_MOVE_NOT_ALLOWED 12
...
private:
    ...
    void loadSprite(vector<pair<pair<int, int>, char>> positions, int id);   //utility to insert in the loadedSprites map
