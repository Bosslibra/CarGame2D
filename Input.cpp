 ...
 * @brief
 *
 * @return 0 if both Up and Down or both Left and Right are pressed simultaneously
 *
...
/**
 * @brief Returns 9 if either Spacebar or Enter are pressed
 *
 * @return int spacebar pressed
 */
